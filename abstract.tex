...
We propose a declarative logic programming language called Linear Meld that is suited to run graph-based programs.
Although Linear Meld is declarative and runs in parallel it also solves the problem of programmer control by introducing coordination directives.

...
talk briefly about linear logic and definitions/fixpoints

\subsection{Comprehensions and Aggregates}
\subsection{Cut-Elimination Proof}

\section{High Level Dynamic Semantics}

present the high level dynamic semantics
...
not sure if i'm going to write down the complete high level system or just the general ideas

add to appendix?

\section{Soundness Proof}

state the soundness proof theorem.
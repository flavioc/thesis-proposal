...
Due to the resource interpretation of the logic, linear logic present a good basis for programming
...
in order to create parallelism and then uses this principle to prove properties about
the system.
